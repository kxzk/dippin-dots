...
DEFAULT_PROMOTION_NAME = "Deploy to Staging"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Promote an Amadeus Semaphore pipeline to the data staging namespace."
    )
    parser.add_argument("--pipeline-id", required=True, help="Semaphore CI pipeline id.")
    parser.add_argument("--namespace", required=True, help="Target namespace, usually data.")
    parser.add_argument(
        "--promotion-name",
